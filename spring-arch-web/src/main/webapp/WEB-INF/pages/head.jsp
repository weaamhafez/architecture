...
<link type="text/css" rel="stylesheet" href="<c:url value="/libs/bootstrap/css/bootstrap.css"/>" >
...
<link href="<c:url value="/libs/DataTables/media/css/dataTables.bootstrap.css"/>" rel="stylesheet">
