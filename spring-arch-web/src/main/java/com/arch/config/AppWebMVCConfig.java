...
import com.arch.audit.SpringSecurityAuditorAware;
import com.arch.model.um.user.*;
import com.arch.server.datatables.DataTableRequestResolver;
...
public class AppWebMVCConfig extends WebMvcConfigurerAdapter {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.arch.model");
